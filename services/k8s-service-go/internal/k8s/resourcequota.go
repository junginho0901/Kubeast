...
func (s *Service) GetResourceQuotas(ctx context.Context, namespace string) ([]map[string]interface{}, error) {
	list, err := s.clientsetCtx(ctx).CoreV1().ResourceQuotas(namespace).List(ctx, metav1.ListOptions{})
	if err != nil {
...
func (s *Service) GetAllResourceQuotas(ctx context.Context) ([]map[string]interface{}, error) {
	list, err := s.clientsetCtx(ctx).CoreV1().ResourceQuotas("").List(ctx, metav1.ListOptions{})
	if err != nil {
...
func (s *Service) DescribeResourceQuota(ctx context.Context, namespace, name string) (map[string]interface{}, error) {
	...
	go func() {
		defer wg.Done()
		rq, rqErr = s.clientsetCtx(ctx).CoreV1().ResourceQuotas(namespace).Get(ctx, name, metav1.GetOptions{})
	}()
	go func() {
		defer wg.Done()
...
func (s *Service) DeleteResourceQuota(ctx context.Context, namespace, name string) error {
	return s.clientsetCtx(ctx).CoreV1().ResourceQuotas(namespace).Delete(ctx, name, metav1.DeleteOptions{})
}
