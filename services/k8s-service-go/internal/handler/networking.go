...
func (h *Handler) DeleteIngress(w http.ResponseWriter, r *http.Request) {
	if err := h.requirePermissionForCluster(r, "resource.ingress.delete"); err != nil {
		h.handleError(w, err)
		return
	}
	ctx := r.Context()
...
func (h *Handler) DeleteIngressClass(w http.ResponseWriter, r *http.Request) {
	if err := h.requirePermissionForCluster(r, "resource.ingressclass.delete"); err != nil {
		h.handleError(w, err)
		return
	}
	ctx := r.Context()
...
func (h *Handler) DeleteEndpoints(w http.ResponseWriter, r *http.Request) {
	if err := h.requirePermissionForCluster(r, "resource.endpoints.delete"); err != nil {
		h.handleError(w, err)
		return
	}
	ctx := r.Context()
...
func (h *Handler) DeleteEndpointSlice(w http.ResponseWriter, r *http.Request) {
	if err := h.requirePermissionForCluster(r, "resource.endpointslice.delete"); err != nil {
		h.handleError(w, err)
		return
	}
	ctx := r.Context()
...
func (h *Handler) DeleteNetworkPolicy(w http.ResponseWriter, r *http.Request) {
	if err := h.requirePermissionForCluster(r, "resource.networkpolicy.delete"); err != nil {
		h.handleError(w, err)
		return
	}
	ctx := r.Context()
