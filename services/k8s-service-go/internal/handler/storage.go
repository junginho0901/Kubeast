...
func (h *Handler) DeletePVC(w http.ResponseWriter, r *http.Request) {
	if err := h.requirePermissionForCluster(r, "resource.pvc.delete"); err != nil {
		h.handleError(w, err)
		return
	}
	ctx := r.Context()
...
func (h *Handler) DeletePV(w http.ResponseWriter, r *http.Request) {
	if err := h.requirePermissionForCluster(r, "resource.pv.delete"); err != nil {
		h.handleError(w, err)
		return
	}
	ctx := r.Context()
...
func (h *Handler) DeleteStorageClass(w http.ResponseWriter, r *http.Request) {
	if err := h.requirePermissionForCluster(r, "resource.storageclass.delete"); err != nil {
		h.handleError(w, err)
		return
	}
	ctx := r.Context()
...
func (h *Handler) DeleteVolumeAttachment(w http.ResponseWriter, r *http.Request) {
	if err := h.requirePermissionForCluster(r, "resource.volumeattachment.delete"); err != nil {
		h.handleError(w, err)
		return
	}
	ctx := r.Context()
