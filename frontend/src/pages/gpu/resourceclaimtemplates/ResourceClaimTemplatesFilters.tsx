// ResourceClaimTemplates 페이지의 검색 + 네임스페이스 드롭다운 필터
//
// frontend/src/pages/gpu/ResourceClaimTemplates.tsx 의 Search input +
// Namespace dropdown + click-outside useEffect 추출. ResourceClaim 의
// Filters 와 사실상 동일.
...
export function ResourceClaimTemplatesFilters({
  searchQuery,
  setSearchQuery,
  selectedNamespace,
