// ResourceClaims 페이지의 검색 + 네임스페이스 드롭다운 필터
//
// frontend/src/pages/gpu/ResourceClaims.tsx 의 Search input +
// Namespace dropdown + click-outside useEffect 추출. dropdown 의 ref/effect 는
// 이 컴포넌트 자체 보유. PVCFilters / 다른 list-page Filters 와 동일 패턴.
...
export function ResourceClaimsFilters({
  searchQuery,
  setSearchQuery,
  selectedNamespace,
