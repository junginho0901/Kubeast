// PersistentVolumes 페이지의 검색 필터
//
// frontend/src/pages/storage/PersistentVolumes.tsx 의 Search input 추출.
// PV 는 cluster-scoped 라 namespace dropdown 없음 (search 만).
