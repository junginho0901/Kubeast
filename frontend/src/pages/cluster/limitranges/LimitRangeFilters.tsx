// LimitRanges 페이지 상단 필터 (검색 + namespace dropdown).
//
// LimitRanges.tsx 본체에서 분리. search input + namespace dropdown +
// click-outside useEffect 를 자체 보유. 부모는 controlled props 만 전달.

import { useEffect, useRef, useState } from 'react'
import { useTranslation } from 'react-i18next'
import { ChevronDown, Search } from 'lucide-react'

interface LimitRangeFiltersProps {
  searchQuery: string
...
export function LimitRangeFilters({
  searchQuery,
  onSearchChange,
  selectedNamespace,
  onNamespaceChange,
  namespaces,
}: LimitRangeFiltersProps) {
