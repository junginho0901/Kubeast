// Ingress 목록 테이블 + sort 헤더 + pagination
//
// frontend/src/pages/network/Ingresses.tsx 의 table JSX (sort header + tbody +
...
interface Props {
  pagedIngresses: IngressInfo[]
  sortedIngressesLength: number
  isLoading: boolean
